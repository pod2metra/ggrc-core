...
class RestClient(object):
    ...
    STATUS_CODES = {'OK': 200, 'FAIL': [400, 404, 500]}

    def __init__(self, endpoint):
        self.is_api = "" if endpoint == url.QUERY else url.API
        self.endpoint_url = urlparse.urljoin(environment.APP_URL,
    ...
    """
        ...
        req_headers["Cookie"] = "session={value}".format(
    ...
    def update_object(self, href, **kwargs):
        ...
        update_obj_resp = requests.put(
            url=href_url,
            data=update_obj_req_body,
            headers=update_obj_req_headers)
