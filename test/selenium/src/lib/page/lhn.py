...
class _Directives(lhn.DropdownStatic):
    ...
    def __init__(self, driver):
        ...
        self.toggle_regulations = lhn.Toggle(self._driver,
        ...
        self.toggle_clauses = lhn.Toggle(self._driver, locator.LhnMenu.CLAUSES,
                                         locator.LhnMenu.CLAUSES_COUNT)
        self.toggle_sections = lhn.Toggle(self._driver,
