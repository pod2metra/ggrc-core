  ...
  """
    ...
    """
        ...
        if (isinstance(left, list) and isinstance(right, list) and all(
                isinstance(_left, Entity.all_entities_classes())
                and isinstance(_right, Entity.all_entities_classes())
    ...
    """
        ...
        if (isinstance(left, Entity.all_entities_classes())
            ...
            for _right in right:
                ...
                assertion_error_msg = (
                    assertion_error_msg + cls.diff_error_msg(left, _right))
        return assertion_error_msg
