...
class Lhn(object):
    ...
    class __metaclass__(type):
        def __init__(cls, *args):
            ...
            cls.DIRECTIVES_MEMBERS = (cls.REGULATIONS, cls.POLICIES,
                                      cls.STANDARDS, cls.CONTRACTS,
                                      cls.CLAUSES, cls.SECTIONS)
            cls.CONTROLS_OR_OBJECTIVES_MEMBERS = (cls.CONTROLS, cls.OBJECTIVES)
            cls.PEOPLE_OR_GROUPS_MEMBERS = (cls.PEOPLE, cls.ORG_GROUPS,
                                            cls.VENDORS, cls.ACCESS_GROUPS)
            cls.ASSETS_OR_BUSINESS_MEMBERS = (cls.SYSTEMS, cls.PROCESSES,
                                              cls.DATA_ASSETS, cls.PRODUCTS,
                                              cls.PROJECTS, cls.FACILITIES,
                                              cls.MARKETS)
            cls.RISKS_OR_THREATS_MEMBERS = (cls.RISKS, cls.THREATS)
...
class AdminWidgetRoles(object):
 ...
 """
    ...
    ROLE_SCOPES_LIST = [
        ROLE_SCOPE_ADMINISTRATOR, ROLE_SCOPE_CREATOR, ROLE_SCOPE_EDITOR,
        ROLE_SCOPE_PROGRAM_EDITOR, ROLE_SCOPE_PROGRAM_MANAGER,
        ROLE_SCOPE_PROGRAM_READER, ROLE_SCOPE_READER,
        ROLE_SCOPE_WORKFLOW_MEMBER, ROLE_SCOPE_WORKFLOW_MANAGER
    ]
...
class CommonObjective(Common):
    ...
    OBJECTIVE = objects.get_normal_form(
        objects.get_singular(objects.OBJECTIVES))
    STATE = Base.STATE
    ADMIN = roles.ADMIN
    PRIMARY_CONTACTS = roles.PRIMARY_CONTACTS
    CREATORS = roles.CREATORS
...
class ProgramInfoWidget(CommonProgram):
    ...
    WIDGET_HEADER = Base.WIDGET_INFO_HEADER_FORMAT.format(
...
class AssessmentTemplateModalSetVisibleFields(CommonModalSetVisibleFields):
 ...
 """
    ...
    DEFAULT_SET_FIELDS = (CommonModalSetVisibleFields.TITLE,
...
class AssessmentModalSetVisibleFields(CommonModalSetVisibleFields):
 ...
 """
    ...
    DEFAULT_SET_FIELDS = (CommonModalSetVisibleFields.TITLE,
                          ...
                          CommonModalSetVisibleFields.CODE, CREATORS,
                          ASSIGNEES, VERIFIERS)
...
class ControlModalSetVisibleFields(CommonModalSetVisibleFields):
 ...
 """
    ...
    DEFAULT_SET_FIELDS = (CommonModalSetVisibleFields.TITLE,
                          ...
                          CommonModalSetVisibleFields.STATE,
                          CommonModalSetVisibleFields.LAST_UPDATED_BY,
                          REVIEW_STATE, PRIMARY_CONTACTS, ADMIN)
...
class ObjectiveModalSetVisibleFields(CommonModalSetVisibleFields):
 ...
 """
    ...
    ADMIN = TransformationSetVisibleFields.ADMIN
    EFFECTIVE_DATE = Base.EFFECTIVE_DATE
    DEFAULT_SET_FIELDS = (CommonModalSetVisibleFields.TITLE, ADMIN,
                          CommonModalSetVisibleFields.CODE,
                          CommonModalSetVisibleFields.STATE, REVIEW_STATE)
...
class ProgramModalSetVisibleFields(CommonModalSetVisibleFields):
 ...
 """
    ...
    DEFAULT_SET_FIELDS = (CommonModalSetVisibleFields.TITLE,
                          ...
                          CommonModalSetVisibleFields.STATE,
                          CommonModalSetVisibleFields.LAST_UPDATED_BY,
                          REVIEW_STATE, MANAGER, PRIMARY_CONTACTS)


class MappingStatusAttrs(
        namedtuple('_MappingStatusAttrs',
