...
class TestSnapshotBlockConverter(unittest.TestCase):
    ...
    def test_get_content_string(self, content, attr_name, expected_value):
        ...
        self.assertEqual(
            self.block.get_content_string(content, attr_name), expected_value)
    ...
    @ddt.data(
        ...
        }, "dummy_date", "2017-04-08 17:57:09"),
    )
    @ddt.unpack
    ...
    def test_get_cav_value_string(self, value, expected_value):
        ...
        self.block._stub_cache = {"Person": {4: "user@example.com"}}
        self.assertEqual(
            self.block.get_cav_value_string(value), expected_value)
    ...
    def test_cav_attr_line(self, content, expected_line):
        ...
        self.block.get_cav_value_string = lambda x: (x.get("attribute_value") if x else "")
        self.block._cad_map = OrderedDict([
            (3, {
                "id": 3,
                "title": "AAA"
