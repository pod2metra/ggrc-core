...
class TestAssessmentMixins(test_mixins_base.TestMixinsBase):
    ...
    def setUp(self):
        ...
        self.attributes_introduced = [
            ...
            ('object', dict),
            ('status',
             attributes.InstrumentedAttribute),  # Stateful       # noqa
            ('assignees', property),  # Assignable     # noqa
            ('custom_attribute_values',
             attributes.InstrumentedAttribute),  # CustomAttrib.  # noqa
            ('description',
             attributes.InstrumentedAttribute),  # Described      # noqa
            ('end_date',
             attributes.InstrumentedAttribute),  # Timeboxed      # noqa
            ('notes',
             attributes.InstrumentedAttribute),  # Noted          # noqa
            ('document_url', property),  # Documentable   # noqa
            ('document_evidence', property),  # Documentable   # noqa
            ('object_people',
             attributes.InstrumentedAttribute),  # Personable     # noqa
            ('os_state',
             attributes.InstrumentedAttribute),  # HasObjectState # noqa
            ('reference_url', property),  # Documentable   # noqa
            ('related_sources',
             attributes.InstrumentedAttribute),  # Relatable      # noqa
            ('related_destinations',
             attributes.InstrumentedAttribute),  # Relatable      # noqa
            ('slug',
             attributes.InstrumentedAttribute),  # Slugged        # noqa
            ('start_date',
             attributes.InstrumentedAttribute),  # Timeboxed      # noqa
            ('test_plan',
             attributes.InstrumentedAttribute),  # TestPlanned    # noqa
            ('title',
             attributes.InstrumentedAttribute),  # Titled         # noqa
        ]
