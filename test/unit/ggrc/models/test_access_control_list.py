...
class TestAccessControlList(unittest.TestCase):
    ...
    ACL_OBJECTS = ('AccessGroup', 'Assessment', 'Clause', 'Contract',
                   'Control', 'DataAsset', 'Facility', 'Issue', 'Market',
                   'Objective', 'OrgGroup', 'Policy', 'Process', 'Product',
                   'Project', 'Program', 'Regulation', 'Risk', 'Section',
                   'Standard', 'System', 'System', 'Process', 'Threat',
                   'Vendor')
