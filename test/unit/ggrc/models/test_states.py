...
class TestStates(unittest.TestCase):
    ...
    BASIC_STATE_OBJECTS = ('AccessGroup', 'Clause', 'Contract', 'Control',
                           'DataAsset', 'Directive', 'Facility', 'Market',
                           'Objective', 'OrgGroup', 'Policy', 'Process',
                           'Product', 'Program', 'Project', 'Regulation',
                           'Risk', 'Section', 'Standard', 'System',
    ...
    def test_issue_states(self):
        ...
        issue_states = ('Draft', 'Active', 'Deprecated', 'Fixed',
                        'Fixed and Verified')
