...
ARCHIVED_CONTEXT_OBJECTS = ('archived_assessment', 'archived_template')
...
def _create_obj_dict(obj, audit_id, context_id, assessment_id=None):
    ...
    return {table_singular: dicts[table_singular]}
        ...
        with app.app_context():
            ...
            for audit, name in ((cls.audit, 'template'),
                ...
                factories.RelationshipFactory(
                    source=audit, destination=template, context=audit.context)
...
class TestArchivedAudit(TestAuditArchivingBase):
  ...
  """
    ...
    @data(('Admin', 200, 'audit'), ('Editor', 200, 'audit'),
          ('Reader', 403, 'audit'), ('Creator', 403, 'audit'),
          ('Creator PM', 200, 'audit'), ('Creator PE', 200, 'audit'),
          ('Creator PR', 403, 'audit'), ('Admin', 403, 'archived_audit'),
          ('Editor', 403, 'archived_audit'), ('Reader', 403, 'archived_audit'),
    ...
    @data(('Admin', 200, CONTEXT_OBJECTS), ('Editor', 200, CONTEXT_OBJECTS),
          ('Reader', 403, CONTEXT_OBJECTS), ('Creator', 403, CONTEXT_OBJECTS),
    ...
    @data(('Admin', 200, 'snapshot'), ('Editor', 200, 'snapshot'),
          ('Reader', 403, 'snapshot'), ('Creator', 403, 'snapshot'),
          ('Creator PM', 200, 'snapshot'), ('Creator PE', 200, 'snapshot'),
          ('Creator PR', 403, 'snapshot'), ('Admin', 403, 'archived_snapshot'),
...
class TestArchivedAuditObjectCreation(TestCase):
    ...
    def test_object_creation(self, obj, archived_status):
        ...
        response = self.api.post(obj,
                                 _create_obj_dict(obj, audit[0], audit[1],
                                                  assessment_id))
        ...
        response = self.api.post(obj,
                                 _create_obj_dict(obj, archived_audit[0],
                                                  archived_audit[1],
                                                  assessment_id))
