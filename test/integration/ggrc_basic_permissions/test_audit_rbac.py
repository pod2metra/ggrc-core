...
class TestAuditRBAC(TestCase):
    ...
    def setUpClass(cls):
        ...
        destinations = set(
            r.destination for r in cls.audit.related_destinations)
        related = [
    ...
    def test_delete_action(self):
        ...
        self.assertFalse(
            all_models.AssessmentTemplate.query.filter(
                all_models.AssessmentTemplate == self.assessment_template.id)
            .all())
  ...
  """
    ...
    def setUp(self):
        ...
        factories.AccessControlListFactory(
            ac_role=ac_role, object=assessment, person=self.reader)
        factories.RelationshipFactory(source=audit, destination=assessment)
        document = factories.DocumentFactory()
        document_id = document.id
        doc_rel = factories.RelationshipFactory(
