...
class TestIssueTrackerIntegration(SnapshotterBaseTestCase):
    ...
    def test_update_issuetracker_info(self, mock_update_issue):
        ...
        with patch.object(
            ...
            with patch.object(
                    issues_module.Client, 'update_issue',
...
@patch(
    "ggrc.models.hooks.issue_tracker._is_issue_tracker_enabled",
    return_value=True)
...
class TestIssueTrackerIntegrationPeople(SnapshotterBaseTestCase):
    ...
    EMAILS = {
        "Audit Captains":
        {"audit_captain_1@example.com", "audit_captain_2@example.com"},
        ...
        "Primary Contacts":
        {"primary_contact_1@example.com", "primary_contact_2@example.com"},
        "Secondary Contacts":
        {"secondary_contact_1@example.com", "secondary_contact_2@example.com"},
        "Custom Role": {"curom_role_1@example.com"},
    }

    ROLE_NAMES = ("Creators", "Assignees", "Verifiers", "Primary Contacts",
                  "Secondary Contacts", "Custom Role")
    ...
    def setUp(self):
        ...
        self.roles = {
            ...
            for role in all_models.AccessControlRole.query.filter(
                all_models.AccessControlRole.name.in_(self.EMAILS.keys(), ), )
        }
        ...
        with factories.single_commit():
            ...
            self.people = {
                role_name:
                [factories.PersonFactory(email=email) for email in emails]
            ...
            for role_name, people in role_name_to_people.iteritems():
                ...
                for person in people:
                    factories.AccessControlListFactory(
                        person=person, ac_role=role, object=self.audit)
