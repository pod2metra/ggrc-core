...
def snapshot_identity(s_1, s_2):
    return (s_1.id == s_2.id and s_1.updated_at == s_2.updated_at
            and s_1.child_id == s_2.child_id
            and s_1.child_type == s_2.child_type
            and s_1.revision_id == s_2.revision_id)
