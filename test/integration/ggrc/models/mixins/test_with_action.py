...
class TestDocumentWithActionMixin(TestCase, WithQueryApi):
    ...
    def test_map_document_issue(self):
        ...
        relationship = _get_relationship("Issue", response.json["issue"]["id"])
        self.assertEqual(relationship.destination_id, document.id)
    ...
    assessment."""
        assessment = factories.AssessmentFactory()
        document = factories.DocumentFactory()
        rel_id = factories.RelationshipFactory(
            source=assessment, destination=document).id
        response = self.api.put(
            assessment, {
                "actions": {
                    "remove_related": [{
    ...
    issue."""
        ...
        document = factories.DocumentFactory()
        rel_id = factories.RelationshipFactory(
            source=issue, destination=document).id
        response = self.api.put(
            issue, {
                "actions": {
                    "remove_related": [{
    ...
    assessment."""
        ...
        document = factories.DocumentFactory()
        rel_id = factories.RelationshipFactory(
            destination=assessment, source=document).id
        response = self.api.put(
            assessment, {
                "actions": {
                    "remove_related": [{
    ...
    issue."""
        ...
        document = factories.DocumentFactory()
        rel_id = factories.RelationshipFactory(
            destination=issue, source=document).id
        response = self.api.put(
            issue, {
                "actions": {
                    "remove_related": [{
    ...
    def test_document_indexing(self):
        ...
        assessments_by_url = self.simple_query(
            "Assessment", expression=["evidence url", "~", "google.com"])
...
class TestCommentWithActionMixin(TestCase):
    ...
    def test_add_comment(self):
        ...
        for acr in acrs:
            factories.AccessControlListFactory(
                ac_role=acr, object=assessment, person=reader)
    ...
    def test_wrong_comment(self):
        ...
        err = u"Fields {} are missing for action: {!r}".format(
            "description", data)
    ...
    def test_remove_comment(self):
        ...
        rel_id = factories.RelationshipFactory(
            source=assessment, destination=comment).id
        response = self.api.put(
            assessment, {
                "actions": {
                    "remove_related": [{
...
class TestSnapshotWithActionMixin(TestCase, WithQueryApi):
    ...
    def test_add_snapshot(self):
        ...
        audits = self.simple_query(
            'Audit', expression=["description", "~", "'control-9'"])
    ...
    def test_remove_snapshot(self):
        ...
        assessment, snapshot = _create_snapshot()
        rel_id = factories.RelationshipFactory(
            source=assessment, destination=snapshot).id
        response = self.api.put(
            assessment, {
                "actions": {
                    "remove_related": [{
...
class TestMultiplyActions(TestCase, WithQueryApi):
    ...
    def test_multiply_actions(self):
        ...
        factories.RelationshipFactory(source=assessment, destination=doc_del)
