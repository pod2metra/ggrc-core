...
class TestCustomAttributeImportExport(TestCase):
    ...
    """
        ...
        gen("access_group",
            attribute_type="Text",
            title="access group test custom",
            mandatory=True)
    ...
    """
        ...
        prod_0_new = {
            c.custom_attribute.title: c.attribute_value
    ...
    def test_multi_word_object_with_ca(self):
        ...
        for id_ in range(1, 11):
            ...
            filtered = [
                val for val in access_group.custom_attribute_values
                if val.attribute_value == "some text {}".format(id_)
            ]
