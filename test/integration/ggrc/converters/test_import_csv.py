...
class TestBasicCsvImport(TestCase):
    ...
    def test_policy_basic_import(self):
        ...
        revisions = models.Revision.query.filter(
            models.Revision.resource_type == "Policy").count()
    ...
    def test_policy_import_working_with_warnings(self):
        ...
        def test_owners(policy):
            ...
            owner = models.Person.query.filter_by(
    ...
    def test_policy_same_titles(self):
        ...
        expected_errors = {
            errors.DUPLICATE_VALUE_IN_CSV.format(
                line_list="3, 4, 6, 10, 11",
                column_name="Title",
                value="A title",
                s="s",
                ignore_lines="4, 6, 10, 11"),
            errors.DUPLICATE_VALUE_IN_CSV.format(
                line_list="5, 7",
                column_name="Title",
    ...
    def test_duplicate_people_objective(self):
        ...
        self.generator.generate_object(models.Objective,
                                       {"slug": "objective1"})
