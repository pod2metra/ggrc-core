...
class TestAssessmentDataHandlers(TestCase):
    ...
    def test_open_assessment(self):
        ...
        revisions = Revision.query.filter_by(
            resource_type='Notification', resource_id=notif.id).count()
    ...
    def test_declined_assessment(self):
        ...
        notifs = self._get_notification(self.asmt1,
                                        "assessment_declined").all()
        self.assertEqual(1, len(notifs))
        notif = notifs[0]
