...
class WithQueryApi(object):
    ...
    def assertEqual(self, first, second, msg=None, sort_sublists=False):
    ...
    def _post(self, data):
        ...
        return self.client.post(
            "/query", data=json.dumps(data), headers=headers)
    ...
    @staticmethod
    def _make_query_dict_base(object_name,
                              type_=None,
                              filters=None,
                              limit=None,
                              order_by=None):
    ...
    """
        ...
        return cls._make_query_dict_base(
            object_name, filters=filters, *args, **kwargs)

    @classmethod
    def _make_snapshot_query_dict(cls,
                                  child_type,
                                  expression=None,
                                  *args,
                                  **kwargs):
        ...
        return cls._make_query_dict_base(
            "Snapshot", filters=filters, *args, **kwargs)
    ...
    def simple_query(self,
        ...
        return self._get_first_result_set(
            self._make_query_dict(
                model_name, expression=expression, *args, **kwargs),
            model_name, field)
...
class TestQueryHelper(TestCase, WithQueryApi):
    ...
    def test_assert_qual_with_sublists(self):
        ...
        self.assertEqual(
            self._sort_sublists(unordered_list),
