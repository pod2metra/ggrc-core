...
class TestExportMultipleObjects(TestCase):
  ...
  """
    ...
    def test_workflow_task_group_mapping(self):
        ...
        self.assertEqual(3,
                         response.count("wf-1"))  # 1 for wf and 1 on each tg
    ...
    def test_workflow_cycle_mapping(self):
        ...
        data = [
            ...
            {
                "object_name":
                "Cycle",  # sholud be same cycle as in first block
                "filters": {
                    "expression": {
                        "op": {
                            "name": "relevant"
        ...
        response = self.export_csv(data).data
        self.assertEqual(3,
                         response.count("wf-1"))  # 2 for cycles and 1 for wf
    ...
    def test_wf_indirect_relevant_filters(self):
        ...
        for object_name, slug, count in destinations:
            ...
            response = self.export_csv(data).data
            self.assertEqual(count, response.count(",p"),
