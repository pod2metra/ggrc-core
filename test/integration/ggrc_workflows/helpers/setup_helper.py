...
class WorkflowSetup(person_setup.PersonSetup):
    ...
    """
        ...
        factories.AccessControlListFactory(
            ac_role=wf_acr, object=workflow, person=wf_person)
    ...
    """
        ...
        for g_rname in wfa_g_rnames:
            self._setup_wf_person(g_rname, ac_roles.workflow.ADMIN_NAME,
                                  workflow)

        for g_rname in wfm_g_rnames:
            self._setup_wf_person(g_rname, ac_roles.workflow.MEMBER_NAME,
                                  workflow)
