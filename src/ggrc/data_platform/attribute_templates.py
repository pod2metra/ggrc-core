...
class AttributeTemplates(base.Base, db.Model):
    ...
    object_template_id = db.Column(
        db.Integer, db.ForeignKey('object_templates.object_template_id'))
    ...
    attribute_definition = orm.relationship(
        "AttributeDefinitions", backref="attribute_templates")
    object_template = orm.relationship(
        "ObjectTemplates", backref="attribute_templates")
