...
def search():
    ...
    if extra_params:
        ...
        extra_params = {
            k: {kk: vv
                for kk, vv in (x.split('=') for x in v.split(','))}
    ...
    if extra_columns:
        ...
        extra_columns = {
            k: v
            for k, v in (x.split('=') for x in extra_columns.split(','))
        }
    ...
    if relevant_objects is not None:
        relevant_objects = [
            tuple(obj.split(':')) for obj in relevant_objects.split(',')
        ]
