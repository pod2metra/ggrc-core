...
def downgrade():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("access_control_list_ibfk_3", 'access_control_list', type_='foreignkey')
    op.drop_constraint("access_control_list_ibfk_4", 'access_control_list', type_='foreignkey')
    op.drop_constraint("access_control_list_ibfk_5", 'access_control_list',
                       type_='foreignkey')
    op.alter_column('access_control_list', 'ac_role_id',
               existing_type=mysql.INTEGER(display_width=11),
               nullable=False)
