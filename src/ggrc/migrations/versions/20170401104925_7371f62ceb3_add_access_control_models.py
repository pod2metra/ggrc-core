...
def upgrade():
    ...
    op.create_table(
        'access_control_roles', sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(
        ...
        'access_control_roles', ['context_id'],
        unique=False)
    op.create_index(
    ...
    op.create_table('access_control_list',
                    ...
                    sa.UniqueConstraint('person_id', 'ac_role_id', 'object_id',
                                        'object_type'))
    op.create_index(
        'fk_access_control_list_contexts',
        'access_control_list', ['context_id'],
        unique=False)
    op.create_index(
        'ix_access_control_list_updated_at',
        'access_control_list', ['updated_at'],
        unique=False)
