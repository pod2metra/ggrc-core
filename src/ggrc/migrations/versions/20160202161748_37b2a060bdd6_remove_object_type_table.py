...
def upgrade():
  ...
  """
    ...
    op.execute("ALTER TABLE notifications "
               "ADD COLUMN object_type VARCHAR(250) NOT NULL "
               "AFTER object_id;")

    op.execute("UPDATE notifications AS n "
...
def downgrade():
  ...
  """
    ...
    object_types_table = op.create_table(
        'object_types', sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.bulk_insert(object_types_table, [
        {
            "name": "Workflow",
            "description": ""
        },
        ...
        {
            "name": "CycleTaskGroupObject",
            "description": ""
        },
        {
            "name": "CycleTaskGroupObjectTask",
            "description": ""
        },
    ])
