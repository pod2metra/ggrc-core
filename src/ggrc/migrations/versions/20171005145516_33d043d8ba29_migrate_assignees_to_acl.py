...
def create_translation_table(table_name, translation_data):
    ...
    op.bulk_insert(roles_translation_tbl, [{
        "old_name": old,
        "new_name": new
    } for old, new in translation_data])
...
def upgrade():
  ...
  """)
    ...
    op.create_index(
        ...
        'temp_assigned_objects', ['assignable_id', 'assignable_type'],
        unique=False)
...
def downgrade():
    ...
    create_translation_table("ac_roles_translation",
