...
def create_tables():
    ...
    op.create_table("namespaces",
                    ...
                    sa.Column(
                        "display_name", sa.Unicode(length=255),
                        nullable=False),
    ...
    op.create_table(
        "attributes", sa.Column("attribute_id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_source",
        "attributes", ["source_type", "source_id", "source_attr"],
        unique=False)
    op.create_index(
        "ix_value_datetime", "attributes", ["value_datetime"], unique=False)
    op.create_index(
        "ix_value_integer", "attributes", ["value_integer"], unique=False)
...
def populate_tables():
    ...
    op.bulk_insert(object_templates, [{
    ...
    op.bulk_insert(attribute_types,
                   [{
                       "attribute_type_id": 1,
    ...
    op.bulk_insert(attribute_definitions,
                   [{
    ...
    op.bulk_insert(attribute_templates,
                   [{
