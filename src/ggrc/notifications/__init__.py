...
IGNORE_ATTRS = frozenset((
    ...
    u"context_id",
    u"created_at",
    u"custom_attribute_definitions",
    u"custom_attribute_values",
    u"_custom_attribute_values",
    u"finished_date",
    u"id",
    u"modified_by",
    u"modified_by_id",
    u"object_level_definitions",
    u"os_state",
    u"related_destinations",
    u"related_sources",
    u"status",
    u"task_group_objects",
    u"updated_at",
    u"verified_date",
    u"audit_id",
    u"custom_attributes",
...
def get_updated_cavs(new_attrs, old_attrs):
    ...
    old_cavs = {
        cad_names[cav["custom_attribute_id"]]: _get_value(
            cav, cad_types[cav["custom_attribute_id"]])
        for cav in old_cavs
    }
