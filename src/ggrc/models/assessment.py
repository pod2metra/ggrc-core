...
class Assessment(
        Assignable, statusable.Statusable, AuditRelationship,
        AutoStatusChangeable, HasObjectState, TestPlanned, CustomAttributable,
        PublicDocumentable, Commentable, Personable, reminderable.Reminderable,
        Relatable, LastDeprecatedTimeboxed, WithSimilarityScore, FinishedDate,
        VerifiedDate, ValidateOnComplete, Notifiable, WithAction,
        labeled.Labeled, with_last_comment.WithLastComment,
        issuetracker_issue.IssueTracked, BusinessObject, Indexed, db.Model):
  ...
  """
    ...
    design = deferred(
        db.Column(db.String, nullable=False, default=""), "Assessment")
