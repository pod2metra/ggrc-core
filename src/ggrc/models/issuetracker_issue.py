...
class IssuetrackerIssue(Base, db.Model):
    ...
    issue_tracked_obj = utils.PolymorphicRelationship(
        "object_id", "object_type", "{}_issue_tracked")
    ...
    """
        ...
        info = dict(
            self.to_dict(include_issue=True, include_private=True), **info)
  ...
  """
    ...
    def issuetracker_issue(cls):  # pylint: disable=no-self-argument
        ...
        def join_function():
            ...
            return sa.and_(object_type == cls.__name__, object_id == cls.id)
