...
class Issue(Roleable, HasObjectState, TestPlanned, CustomAttributable,
            PublicDocumentable, Personable, LastDeprecatedTimeboxed, Relatable,
            Commentable, AuditRelationship, WithAction, BusinessObject,
            Indexed, db.Model):
    """Issue Model."""
    ...
    VALID_STATES = BusinessObject.VALID_STATES + (
        FIXED,
        FIXED_AND_VERIFIED,
    )
    ...
    _api_attrs = reflection.ApiAttributes(
        ...
        reflection.Attribute(
            "allow_unmap_from_audit", create=False, update=False),
