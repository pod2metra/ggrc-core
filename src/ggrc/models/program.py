...
class Program(HasObjectState, mixins.CustomAttributable,
              object_document.PublicDocumentable, Roleable, Personable,
              Relatable, HasOwnContext, mixins.LastDeprecatedTimeboxed,
