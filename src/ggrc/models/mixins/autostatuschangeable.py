...
class AutoStatusChangeable(object):
  ...
  """
    ...
    FIRST_CLASS_EDIT_MAPPING = {
        'MONITOR_STATES':
        {statusable.Statusable.DONE_STATE, statusable.Statusable.FINAL_STATE},
        'TRACKED_ATTRIBUTES': {
            'title', 'test_plan', 'notes', 'description', 'slug', 'start_date',
            'end_date', 'design', 'operationally', 'assessment_type'
        }
    }
    ...
    RELATED_OBJ_STATUS_MAPPING = {
        ...
        'Comment': {
            'key': lambda _: 'ALL',
            'mappings': {
                'ALL': {statusable.Statusable.START_STATE},
            },
        },
    }
    ...
    """
        ...
        for obj in session.identity_map.values():
            if isinstance(obj,
                          AutoStatusChangeable) and obj._need_status_reset:
    ...
    """
      ...
      """
            ...
            related_mapping = cls.RELATED_OBJ_STATUS_MAPPING.get(
                related_object.type)
        ...
        def handle_document_relationship(sender,
                                         obj=None,
                                         src=None,
                                         service=None):
