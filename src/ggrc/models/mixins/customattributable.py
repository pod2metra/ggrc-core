...
class CustomAttributable(object):
    ...
    _api_attrs = reflection.ApiAttributes(
        ...
        reflection.Attribute(
            'custom_attribute_definitions', create=False, update=False),
        reflection.Attribute(
            'preconditions_failed', create=False, update=False),
    ...
    def custom_attribute_definitions(cls):  # pylint: disable=no-self-argument
        ...
        def join_function():
            ...
            return and_(
                or_(definition_id == cls.id, definition_id.is_(None)),
    ...
    """
        ...
        attr_values = db.session.query(CustomAttributeValue).filter(
            and_(CustomAttributeValue.attributable_type ==
    ...
    def get_custom_attribute_definitions(cls):
        ...
        if cls.__name__ == "Assessment":
            ...
            query = cad.query.filter(cad.definition_type == utils.
                                     underscore_from_camelcase(cls.__name__))
    ...
    def eager_query(cls):
        ...
        query = query.options(
            ...
            .undefer_group('CustomAttributeValue_complete').subqueryload(
        ...
        if hasattr(cls, 'comments'):
            ...
            query = query.options(
                orm.subqueryload('comments').undefer_group('Comment_complete'),
            )
        return query
    ...
    """
        ...
        return any(
            c.preconditions_failed for c in self.custom_attribute_values)
