        ...
        [
            {
                ...
                'ProgramOwner',
                'description':
                'User with authorization to peform administrative '
            ...
            },
            {
                ...
                'ProgramEditor',
                'description':
                'A user with authorization to edit mapping objects '
            ...
            },
            {
                ...
                'ProgramReader',
                'description':
                'A user with authorization to read mapping objects '
                'related to an access controlled program.',
                'permissions_json':
                json.dumps({
                    'create': [],
            ...
            },
            {
                ...
                'RoleReader',
                'description':
                'A user with authorization to read Role resources.',
                'permissions_json':
                json.dumps({
                    'create': [],
                    'read': [
